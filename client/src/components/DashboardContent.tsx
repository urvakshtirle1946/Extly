                ...
                <div className="md:col-span-4 flex flex-col items-center md:items-start text-center md:text-left space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-center md:justify-start gap-2">
                      <h2 className="text-2xl font-bold text-white tracking-tight capitalize">{userDisplayName}</h2>
                      {/* Verified Badge */}
                  ...
                  <div className="flex items-center justify-center md:justify-start gap-5 text-neutral-400 pt-2">
                    ...
                    <a href={`mailto:${user?.email || ''}`} className="hover:text-white hover:scale-110 transition-all duration-200">
